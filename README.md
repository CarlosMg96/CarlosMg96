<h1 align="center">Hola 👋, soy Carlos Rodriguez (CarlosMg96)</h1>
...
**Backend**
- Laravel (5.1 a 12), Node.js, Express
...
- AWS (EC2, S3, RDS, etc.)
- Configuración de servidores (Nginx, Apache, despliegue manual y CI/CD)
